      ...
      <div class="price_container">
        <div class="box-cart">
          ...
          <div class="detail-box">
            ...
            <table class="table table-striped">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td width='30px'><a id="hover" class='btn btn-danger btn-xs' title='Delete' href='<?=base_url()?>produk/keranjang_delete/<?=$row['id_detil_pemesanan']?>'><span class='fa fa-trash'></span></a></td>
                </tr>
                <?php }
                $total = $this->db->query("SELECT sum(harga_pesan) as total FROM `pemesanan_temp` where session='".$this->session->idp."'")->row_array();
                ?>
                <tr>
            ...
            <a class='btn btn-primary btn-sm' href='<?=base_url()?>produk/checkouts'>Selesai</a>
          </div>
        </div>
      </div>
